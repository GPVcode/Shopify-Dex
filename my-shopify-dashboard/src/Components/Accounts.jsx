...
import { fetchAccountTotal } from '../Services/api'; // Ensure this is the correct import path

function Accounts() {
    const { data, isLoading, isError, error } = useQuery('accountTotal', fetchAccountTotal);
    ...
    const totalAccounts = data ? data.data : 0; 
    const percentageIncrease = calculatePercentageIncrease(totalAccounts, 5); // Example calculation
